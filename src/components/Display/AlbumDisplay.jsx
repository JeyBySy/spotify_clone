...
const TestSongList = ({ index }) => {
    ...
    return (
        <div
            ...
            className="grid grid-cols-[40px_1.8fr_100px] items-center gap-3 py-1 rounded hover:bg-neutral-800 px-2 hover:cursor-pointer"
        >
                    ...
                    <div className="bg-green-700 w-full h-[290px] bg-gradient-to-b from-neutral-900/0 to-neutral-900/40">
                        <div className='flex items-center h-full px-6 py-5 pt-8 container mx-auto'>
                            ...
                            <div className='flex flex-col gap-4  text-white text-2xl font-bold px-6 justify-end h-full'>
                                <p className='text-sm font-medium flex items-center'>Album</p>
                                <p className='text-8xl font-black'>JeyBySy</p>
                                <div className="flex items-center gap-1">
                                    <div className="w-6 h-6 bg-blue-900 rounded-full" />
                                    <span className='text-sm font-medium '>JeyBySy • 2,066,782 saves • 10 songs, about 3 hr 15 min</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2 place-items-center bg-gradient-to-t from-custom-main from-85% to-green-700/30 ">
                        ...
                        <section className='w-full container mx-auto'>
                            <div className="flex flex-col gap-2">
                                <div className={`sticky top-[65px] grid grid-cols-[40px_1.8fr_100px] gap-3 items-center text-neutral-200 text-sm py-2 px-6
                        ...
                        <section className='w-full container mx-auto'>
                            ...
                            <div className='flex flex-col'>
                                <Carousel title={"More by JeyBySy"} >
